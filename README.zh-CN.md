...
<p align="center">
  <img src="assets/tier-selected-item.png" alt="已限定物品类型的 Tier 列表" width="36%">
  <img src="assets/tier-multiple-categories.png" alt="可选多个物品类型的 Tier 列表" width="31%">
  <img src="assets/tier-category-labels.png" alt="按物品类型标注的 Tier 列表" width="31%">
</p>
